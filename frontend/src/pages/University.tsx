    ...
    <div>
      <div className="page-head">
        ...
        <section className="card">
          ...
          <p className="helper">
            The key lives in this tab&apos;s memory only. It is sent with each issue/revoke
            request and is gone on reload.
          </p>
        </section>
      </div>
            ...
            <>
              ...
              <div className="kv-section">
                ...
                <dl className="kv-list">
                  ...
                  <dt>University digital signature</dt><dd>generated by the backend using the configured issuer wallet</dd>
